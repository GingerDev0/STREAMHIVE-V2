  ...
  <?php else: ?>
    <div class="v2-related-list">
      <?php foreach ($related as $index => $rel): ?>
        ...
        ?>
        <a class="v2-related-item v2-related-compact text-decoration-none js-media-link" href="<?= e($relLink) ?>" data-fetch-content="0" data-media="<?= media_storage_payload($rel, $relType, $relLink) ?>">
          <span class="v2-related-feature-bg" style="background-image:url('<?= e(tmdb_img($rel['backdrop_path'] ?? ($rel['poster_path'] ?? null), 'w780')) ?>')"></span>
