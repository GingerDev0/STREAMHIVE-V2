...
<p align="center">
  <img src="public/assets/img/logo.png" alt="StreamHIVE 2.5.5 logo" width="420">
</p>
...
<p align="center">
  ...
  <img alt="StreamHIVE 2.5.5" src="https://img.shields.io/badge/version-2.5.5-e50914?style=for-the-badge">
...
**StreamHIVE 2.5.5** is a live TMDB-powered movie and TV discovery app built with PHP. It delivers a polished streaming-service interface with cinematic detail pages, live search, actor profiles, recommendations, local browser profiles, upcoming-release discovery, and configurable embed-player routing.
