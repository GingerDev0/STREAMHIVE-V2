...
?>
<div class="streamhive-js-page-media d-none" data-media="<?= media_storage_payload($item, 'tv', url('tv/'.$item['slug'])) ?>"></div>
<section class="streamhive-v2-detail-hero streamhive-v2-tv-detail-hero">
  ...
  <div class="streamhive-v2-detail-grid">
    ...
    <div class="streamhive-v2-detail-copy">
      ...
      <div class="streamhive-v2-genre-row mb-3"><?= genre_links($item['genres'] ?? [], 'tv', 0, 'streamhive-genre-link') ?></div>
      ...
      <div class="streamhive-v2-hero-actions">
        ...
        <button class="btn btn-outline-light btn-lg streamhive-detail-bookmark streamhive-js-bookmark-btn" type="button" data-media="<?= media_storage_payload($item, 'tv', url('tv/'.$item['slug'])) ?>"><i class="fa-regular fa-bookmark me-2"></i>Save to profile</button>
...
<section id="seasons" class="streamhive-movie-detail-tabs-shell streamhive-actor-credits-shell streamhive-glass rounded-4 p-3 p-lg-4 mt-4" x-data="{ activeDetail: 'seasons' }">
  <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-4">
    <div>
      <span class="streamhive-v2-section-eyebrow"><i class="fa-solid fa-layer-group"></i> TV details</span>
      <h2 class="mb-0 text-white fw-black">Details</h2>
    </div>
    <div class="streamhive-actor-tabs streamhive-movie-detail-tabs" role="tablist" aria-label="TV detail tabs">
      <button class="streamhive-actor-tab streamhive-movie-detail-tab active" :class="{ active: activeDetail === 'seasons' }" type="button" data-movie-detail-tab="seasons" :aria-selected="activeDetail === 'seasons' ? 'true' : 'false'" @click="activeDetail = 'seasons'"><i class="fa-solid fa-layer-group"></i> Seasons <span><?= e((string)count($releasedSeasons)) ?></span></button>
  ...
  <div class="streamhive-movie-detail-panel streamhive-movie-tab-surface streamhive-tv-seasons-panel active" :class="{ active: activeDetail === 'seasons' }" x-show="activeDetail === 'seasons'" data-movie-detail-panel="seasons">
    ...
    <div class="streamhive-movie-tab-surface-inner">
      <div class="streamhive-v2-section-head compact streamhive-movie-tab-surface-head"><div><span class="streamhive-v2-section-eyebrow"><i class="fa-solid fa-layer-group"></i> Episode guide</span><h2>Seasons</h2></div></div>
      <div class="streamhive-movie-season-grid streamhive-v2-related-list">
      <?php foreach ($releasedSeasons as $index => $season): $sn=(int)($season['season_number']??0); ?>
        ...
        ?>
        <a class="streamhive-v2-related-item streamhive-v2-related-compact streamhive-movie-season-card text-decoration-none" href="<?= e($seasonUrl) ?>">
          <span class="streamhive-v2-related-feature-bg" style="background-image:url('<?= e(tmdb_img($seasonPoster, 'w780')) ?>')"></span>
          ...
          <span class="streamhive-v2-related-poster-wrap">
            <img class="streamhive-v2-related-poster" src="<?= e(tmdb_img($seasonPoster, 'w185')) ?>" alt="<?= e($seasonName) ?> poster">
            <span class="streamhive-v2-related-play"><i class="fa-solid fa-list"></i></span>
          </span>
          <span class="streamhive-v2-related-copy">
            <span class="streamhive-v2-related-title"><?= e($seasonName) ?></span>
            ...
            <span class="streamhive-v2-related-score"><i class="fa-solid fa-tv"></i> Season <?= e((string)$sn) ?></span>
          </span>
